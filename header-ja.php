...
<html lang="ja">
  <head>
    ...
    <meta name="description" content="ADFINITYS PTE.LTD.は、最先端の技術と最適化戦略により、質の高い広告体験を提供します。DSPサービスを中心に、アドネットワークやディスプレイ広告を組み合わせた最適な運用プランをご提案します。" />
    <meta name="keywords" content="DSP広告, デジタル広告, 広告代理店, Demand-Side Platform, Google Ads, Amazon Ads, ディスプレイ広告, アドネットワーク, 広告運用, ADFINITYS" />
    <meta name="author" content="ADFINITYS PTE.LTD." />
    <meta name="robots" content="index, follow" />
    <link rel="canonical" href="<?php echo esc_url( get_permalink() ); ?>" />

    <link rel="alternate" hreflang="ja" href="<?php echo esc_url( get_permalink() ); ?>" />
  <!-- todo ENのTOPページリンクに -->
    <link rel="alternate" hreflang="en" href="https://www.superedge.co.jp/en/" />
  <!-- todo EN TOPページURL -->
    ...
    <meta property="og:title" content="ADFINITYS PTE.LTD. | DSP広告・デジタル広告代理店" />
    <meta property="og:description" content="最先端の技術と最適化戦略により、質の高い広告体験を提供します。DSPサービスを中心に、アドネットワークやディスプレイ広告を組み合わせた最適な運用プランをご提案します。" />
    ...
    <meta name="twitter:title" content="ADFINITYS PTE.LTD. | DSP広告・デジタル広告代理店" />
    <meta name="twitter:description" content="最先端の技術と最適化戦略により、質の高い広告体験を提供します。DSPサービスを中心に最適な広告運用プランをご提案します。" />
  ...
  <header id="header">
    ...
    <nav>
      <ul class="page-links">
        <li class="item"><a href="<?php echo esc_url( home_url('/services-jp/') ); ?>">SERVICES</a></li>
        <li class="item"><a href="<?php echo esc_url( home_url('/news-jp/') ); ?>">NEWS</a></li>
        <li class="item"><a href="<?php echo esc_url( home_url('/company-jp/') ); ?>">COMPANY</a></li>
        <li class="item"><a href="<?php echo esc_url( home_url('/recruitment-jp/') ); ?>">RECRUITMENT</a></li>
        <li class="item"><a href="<?php echo esc_url( home_url('/contact-jp/') ); ?>">CONTACT</a></li>
